    ...
    <div className="flex flex-wrap-reverse justify-center items-center my-20">
      <div className="text lg:basis-1/2 flex-shrink lg:pl-20 md:pl-5 ">
        ...
        <div className="flex mt-5 border-b-[1px] border-gray-800 pb-3">
           <button className="text-chatI mx-5 p-3 text-xl bg-chatBg rounded-full "><BiSolidMessageAltDetail></BiSolidMessageAltDetail></button>
       ...
       <div className="flex mt-5">
           <button className="text-locI mx-5 p-3 text-xl bg-locBg rounded-full "><MdLocationOn></MdLocationOn></button>
          <div className=" inline-flex flex-col items-start ">
