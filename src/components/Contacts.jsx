  ...
  return (
    <div className="bg-bg m-auto py-60 flex-col justify-center items-center mx-5" id="contact">
        <div className="flex rounded-full justify-center mb-12">
          ...
          <img src={avtaarsImg.img5} alt="" className="rounded-full w-12 h-12 scale-150 z-20"/>
          <img src={avtaarsImg.img4} alt="" className="rounded-full w-12 h-12 scale-125 z-10"/>
          <img src={avtaarsImg.img3} alt="" className="rounded-full w-12 h-12 scale-95"/>
